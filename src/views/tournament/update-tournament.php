    ...
    <div class="d-flex justify-content-center form-height">
        <form class="p-5 grey-white" method="post" action="/update-tournament">
            ...
            <div class="mx-3 my-2">
                ...
                <input type="text" class="form-control" id="tournamentName" name="tournamentName" value="" required>
            </div>
            <div class="mx-3 my-2">
                <label for="registrationDate" class="form-label d-flex justify-content-center grotesk">Regisztráció dátuma</label>
                <input type="date" class="form-control" id="registrationDate" name="registrationDate"  min="<?php new DateTime("now"); ?>" value="">
            </div>
            <div class="mx-3 my-2">
                <label for="tournamentStartDate" class="form-label d-flex justify-content-center grotesk">Verseny kezdete</label>
                <input type="date" class="form-control" id="tournamentStartDate" name="tournamentStartDate"  min="<?php new DateTime("now"); ?>" value="">
            </div>
            <div class="mx-3 my-2">
                <label for="tournamentEndDate" class="form-label d-flex justify-content-center grotesk">Verseny vége</label>
                <input type="date" class="form-control" id="tournamentEndDate" name="tournamentEndDate"  min="<?php new DateTime("now"); ?>" value="">
            </div>
            <div class="mx-3 my-2">
